...
| 0g | The ground point is on the feet | Put a cat figurine in view and tap `mount` until the red dot sits at its feet, not its flank | The dot tracks the feet as the figurine moves | **PASSED 2026-09-22** — the buffer always arrives in the sensor's native landscape, so a phone standing upright needs 90° and one lying on its side needs 0°. Confirmed upright at 90°: good picture, boxes on the animal. Re-check after mounting |
